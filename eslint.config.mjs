...
// docs/backend/multi-tenant.md et docs/backend/paiements-djomy.md du kit
// de démarrage (darmeuble-kit).
...
// l'implémentation réelle des modules (buildings, units, tenants, leases,
...
const TENANT_SCOPED_MODELS = {
  ...
  // schéma — leur appartenance passe par leur parent direct.
...
export default tseslint.config(
  {
    ignores: [
      ...
      'tools/**',
      // Client Prisma généré (`prisma generate`) — jamais commité (voir
      // .gitignore) ni retouché à la main, donc jamais linté.
      'src/generated/**',
    ],
  },
  ...
  },
  {
    rules: {
      ...
      // docs/backend/coding-rules-backend.md du kit de démarrage.
      'max-lines': [
        'warn',
