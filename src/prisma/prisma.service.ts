...
/**
 * Wrapper injectable autour de PrismaClient. Prisma 7 impose un driver
 * adapter explicite (plus d'URL lue implicitement depuis schema.prisma) :
 * voir prisma.config.ts pour le CLI/migrations, ici pour le client
 * applicatif.
 *
 * **Seule classe autorisée à importer le client Prisma directement** — voir
 * darmeuble-kit/docs/backend/adr/0003-pattern-repository-port-adapter.md.
 * Un service métier injecte un repository, jamais `PrismaService`.
 *
